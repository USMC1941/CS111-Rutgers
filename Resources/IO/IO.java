 ...
 * <ul>
 *    <li>It provides input methods which make it easy to read data from the keyboard and force the user to enter data of a specific type.</li>
 *    <li>It provides output methods which allow us to grade your programs using a grading script.</li>
 * </ul>
 */
public class IO {
	...
	public static boolean readBoolean() {
		...
		while (true) {
			...
			if (s.equalsIgnoreCase("yes") || s.equalsIgnoreCase("y") || s.equalsIgnoreCase("true") || s.equalsIgnoreCase("t")) {
				return true;
			}
			else if (s.equalsIgnoreCase("no") || s.equalsIgnoreCase("n") || s.equalsIgnoreCase("false") || s.equalsIgnoreCase("f")) {
				return false;
			}
			else {
	...
	/**
	 * Print an error message to the screen and/or send it to the grading script. This method does not take any inputs - it always prints the same error message.
	 */
