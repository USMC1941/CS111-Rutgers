public class WebsiteHits {
    ...
    /** this is a global variable, does not appear inside a method visible to all methods */
    ...
    public static void setPageHitsForDay(
            int[][] hits, int pageHitsForDay, String[] pageNames, String pageName, String day) {
        // find row index
