...
public class Date {
    ...
    /** full-fledged (and only) constructor only dates on or after Jan 1, 2015 are allowed */
    public Date(int year, int month, int day) {
        boolean valid = year >= DEFAULT_YEAR && month >= 1 && month <= 12 && day >= 1;
    ...
    /**
     * helper (private) method to check if a given year is a leap year static because it does not
     * refer to any attributes of the object
     */
