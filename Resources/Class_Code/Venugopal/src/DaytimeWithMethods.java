public class DaytimeWithMethods {
    ...
    public static void main(String[] args) {
        ...
        if (!sunRose) {
            ...
            if (light) {
                System.out.print("daylight duration is 24 hours");
            } else {
                System.out.print("daylight duration is 0 hours");
            }
            return;
        }
        ...
        int daylightMins =
                daylightMinutes % 60; // '%' is the "mod" or modulus function, gives remainder

        System.out.printf(
                "daylight duration is %d hours and %d minutes%n", daylightHours, daylightMins);
    }
}
