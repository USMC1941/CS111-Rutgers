...
public class Face extends JFrame {
    ...
    /**
     * Set the expression to be displayed on the face. Valid expressions are "happy", "sad", and
     * "mad". Any other expression will be displayed with a look of confusion.
     *
     * @param expression Textual name of desired expression.
     */
    public void setExpression(String expression) {
        this.expression = expression.toLowerCase();
        repaint(this.insets.left, this.insets.top, this.xsize, this.ysize);
    }
    ...
    /**
     * Determine whether this face and another face look the same (are of the same size and have the
     * same expression).
     *
    ...
    public boolean equals(Object other) {
        ...
        return this.xsize == otherFace.xsize
                && this.ysize == otherFace.ysize
    ...
    /**
     * This method is only for internal use by the GUI framework - you should not call it directly.
     */
    public void paint(Graphics g) {
        ...
        // draw nose
        g.fillArc(
                bounds.x + 9 * eyewidth / 4,
                bounds.y + 9 * eyeheight / 4,
                nosewidth,
                noseheight,
                0,
                360);
        ...
        if (expression.equals("none")) {
            g.drawLine(
                    bounds.x + eyewidth,
                    bounds.y + 7 * eyewidth / 2,
                    bounds.x + 4 * eyewidth,
                    bounds.y + 7 * eyewidth / 2);
            g.drawLine(
                    bounds.x + eyewidth,
                    bounds.y + eyeheight - 2,
                    bounds.x + 2 * eyewidth,
                    bounds.y + eyeheight - 2);
            g.drawLine(
                    bounds.x + 3 * eyewidth,
            ...
            g.drawLine(
                    ...
                    bounds.y + eyeheight - 2);
            g.drawArc(
                    bounds.x + eyewidth, bounds.y + 3 * eyeheight, 3 * eyewidth, eyeheight, 0, 180);
