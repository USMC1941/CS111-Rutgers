...
class Drawing extends JFrame {
	...
	public void drawLine(double startx, double starty, double endx, double endy) {
		drawLine((int) Math.round(startx), (int) Math.round(starty), (int) Math.round(endx), (int) Math.round(endy));
	}
	...
	public void drawSolidCircle(double centerx, double centery, double radius) {
		drawSolidCircle((int) Math.round(centerx), (int) Math.round(centery), (int) Math.round(radius));
	}
