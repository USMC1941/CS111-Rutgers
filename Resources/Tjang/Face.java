...
public class Face extends JFrame {
	...
	public Face(int xsize, int ysize) {
		...
		this.setSize(xsize + this.insets.left + this.insets.right, ysize + this.insets.top + this.insets.bottom);
	...
	public boolean equals(Object other) {
		...
		return this.xsize == otherFace.xsize && this.ysize == otherFace.ysize && this.expression.equals(otherFace.expression);
	}
